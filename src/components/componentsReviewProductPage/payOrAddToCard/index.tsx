...
import { LM, MM, SM, SMM, XLLM, XLM } from "../../../theme/fonts";
...
const SectionPayOrAddToCart = styled.section`
...
const TextsContainerIndividual = styled.div`
    display: flex;
    flex-direction: column;
`;
